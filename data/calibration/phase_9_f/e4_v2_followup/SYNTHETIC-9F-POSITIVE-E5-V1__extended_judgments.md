<!-- calibration_mode=phase_9_f_e4_v2_followup protocol_version=phase_9_f_v1 e5_fixture_version=v1 e4_prompt_version=e4_v2 expected_e4=score:2 observed_e4=score:2 role=synthetic_positive_control -->

# Extended judgments — SYNTHETIC-9F-POSITIVE-E5-V1

- evaluation_uuid: `85928c9d-1216-48d8-99c2-c7afe048f82b`
...
La versione inglese del syllabus presenta un'equivalenza semantica sostanziale e una terminologia coerente rispetto alla versione italiana. Tutte le sezioni sostanziali presenti in italiano hanno una corrispondente traduzione in inglese che veicola le stesse informazioni e gli stessi impegni didattici, senza omissioni rilevanti o cambi di significato. La traduzione è accurata e fedele all'originale.
...
4. Syllabus · `prerequisites_en`
   > **Cultural / general knowledge**: ability to formalise a protocol with precise notation; familiarity with case-based and inductive reasoning; ability to read and analyse technical texts in English; basics of mathematical logic (predicates, quantifiers).

**Specialist / disciplinary knowledge**: data structures and algorithms (balanced trees, graphs, asymptotic complexity); operating systems (processes, scheduling, synchronisation and mutual exclusion); computer networks (ISO/OSI layering, TCP/UDP, RPC); basic concurrent programming (threads, locks, monitors); database fundamentals (ACID transactions, isolation levels).
...
6. Syllabus · `assessment_methods_en`
...
Il syllabus dimostra una sostanziale aderenza agli usi dipartimentali per quanto riguarda la struttura dei prerequisiti, le modalità di verifica dell'apprendimento, il formato dei riferimenti bibliografici e l'esplicitazione delle modalità di frequenza. La sezione dei prerequisiti distingue chiaramente tra conoscenze culturali/generali e disciplinari/specialistiche, come richiesto. Le modalità di verifica specificano i pesi delle componenti d'esame, i voti minimi per l'accesso alle fasi successive e sono presenti esempi di domande. I riferimenti bibliografici sono completi di autore, anno, titolo, editore ed edizione. Infine, la frequenza è chiaramente indicata come facoltativa per le lezioni teoriche e obbligatoria con percentuale per il laboratorio, con indicazioni sulle conseguenze.
