...
const COMMON_BUTTON =
  "inline-flex h-7 min-w-[3rem] items-center justify-center px-3 text-xs font-medium leading-none transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1";
...
export function LanguageToggle({
  ...
  return (
    <div
      role="group"
      aria-label={label}
      className="inline-flex h-9 items-center gap-0.5 bg-slate-100 p-1"
    >
      <button
        type="button"
        onClick={() => onChange("it")}
