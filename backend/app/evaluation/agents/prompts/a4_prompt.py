...
- USO DELLA CONFIDENCE. Per C9 la confidence di default è "medium". Usala "high" SOLO quando hai più evidenze concordanti e specifiche del difetto (o, simmetricamente, della cura). Usa "low" quando la valutazione è particolarmente interpretativa o le evidenze sono ambigue.
...
A4_CRITERIA_SPECS: list[dict[str, Any]] = [
    {
        ...
        "owned_by": "A4",
        "anchors": {
            "0": "Difetti editoriali gravi e ricorrenti: numerosi refusi, formattazione visibilmente compromessa (caratteri di servizio leftover, liste interrotte, doppia spaziatura sistematica), riferimenti bibliografici inutilizzabili (autori senza titolo, link rotti, citazioni non risolvibili), incongruenze evidenti fra IT e EN sui campi del perimetro bilingue, errori grammaticali tali da rendere alcuni punti illeggibili.",
            "1": "Difetti editoriali isolati ma riconoscibili: alcuni refusi sparsi, riferimenti bibliografici parzialmente formattati o di formato disomogeneo, qualche incongruenza minore fra IT e EN, residui di formattazione (es. simboli '-->' o spazi anomali) in poche sezioni. Il documento resta leggibile ma trasmette una compilazione frettolosa.",
            "2": "Documento curato editorialmente: refusi assenti o sporadici e non significativi, riferimenti bibliografici completi e formattati in modo coerente (autori, titolo, anno/edizione, eventuale edizione disponibile), formattazione coerente fra le sezioni, parallelismo editoriale macroscopico fra IT e EN dove entrambe sono presenti (NON equivalenza semantica, che è E4). Le Linee Guida UniCT raccomandano questa cura editoriale come parte della qualità documentale percepita.",
        },
    },
]
